...
| Lean 名 | spec | grep | 位置 |
|---|---|---|---|
| `curve25519_dalek.edwards.CompressedEdwardsY.to_bytes` |  | 29 | curve25519-dalek/src/edwards.rs:L193-L195 |
| `curve25519_dalek.edwards.EdwardsPoint.as_affine_niels` | ✓ | 6 | curve25519-dalek/src/edwards.rs:L543-L553 |
| `curve25519_dalek.edwards.EdwardsPoint.compress` | ✓ | 15 | curve25519-dalek/src/edwards.rs:L607-L609 |
| `curve25519_dalek.edwards.EdwardsPoint.double` | ✓ | 25 | curve25519-dalek/src/edwards.rs:L745-L747 |
| `curve25519_dalek.edwards.EdwardsPoint.is_small_order` | ✓ | 2 | curve25519-dalek/src/edwards.rs:L1367-L1369 |
| `curve25519_dalek.edwards.EdwardsPoint.is_torsion_free` | ✓ | 3 | curve25519-dalek/src/edwards.rs:L1397-L1399 |
| `curve25519_dalek.edwards.EdwardsPoint.mul_base_clamped` | ✓ | 0 | curve25519-dalek/src/edwards.rs:L907-L915 |
| `curve25519_dalek.edwards.EdwardsPoint.mul_clamped` | ✓ | 0 | curve25519-dalek/src/edwards.rs:L891-L903 |
| `curve25519_dalek.montgomery.MontgomeryPoint.as_bytes` | ✓ | 20 | curve25519-dalek/src/montgomery.rs:L199-L201 |
| `curve25519_dalek.montgomery.MontgomeryPoint.mul_base_clamped` | ✓ | 0 | curve25519-dalek/src/montgomery.rs:L150-L158 |
| `curve25519_dalek.montgomery.MontgomeryPoint.mul_clamped` | ✓ | 0 | curve25519-dalek/src/montgomery.rs:L134-L146 |
| `curve25519_dalek.montgomery.MontgomeryPoint.to_bytes` | ✓ | 29 | curve25519-dalek/src/montgomery.rs:L204-L206 |
| `curve25519_dalek.montgomery.MontgomeryPoint.to_edwards` | ✓ | 4 | curve25519-dalek/src/montgomery.rs:L224-L253 |
| `curve25519_dalek.montgomery.elligator_encode` | ✓ | 2 | curve25519-dalek/src/montgomery.rs:L263-L284 |
| `curve25519_dalek.ristretto.CompressedRistretto.decompress` | ✓ | 6 | curve25519-dalek/src/ristretto.rs:L257-L271 |
| `curve25519_dalek.ristretto.CompressedRistretto.to_bytes` | ✓ | 29 | curve25519-dalek/src/ristretto.rs:L230-L232 |
| `curve25519_dalek.ristretto.RistrettoPoint.compress` | ✓ | 15 | curve25519-dalek/src/ristretto.rs:L498-L542 |
| `curve25519_dalek.ristretto.RistrettoPoint.coset4` |  | 1 | curve25519-dalek/src/ristretto.rs:L659-L666 |
| `curve25519_dalek.ristretto.RistrettoPoint.from_uniform_bytes` | ✓ | 3 | curve25519-dalek/src/ristretto.rs:L823-L839 |
| `curve25519_dalek.ristretto.RistrettoPoint.mul_base` | ✓ | 5 | curve25519-dalek/src/ristretto.rs:L988-L998 |
| `curve25519_dalek.scalar.Scalar.as_radix_2w` |  | 3 | curve25519-dalek/src/scalar.rs:L1080-L1140 |
| `curve25519_dalek.scalar.Scalar.batch_invert` |  | 4 | curve25519-dalek/src/scalar.rs:L788-L845 |
| `curve25519_dalek.scalar.Scalar.from_bytes_mod_order` | ✓ | 3 | curve25519-dalek/src/scalar.rs:L237-L246 |
| `curve25519_dalek.scalar.Scalar.from_bytes_mod_order_wide` | ✓ | 4 | curve25519-dalek/src/scalar.rs:L250-L252 |
| `curve25519_dalek.scalar.Scalar.from_canonical_bytes` | ✓ | 5 | curve25519-dalek/src/scalar.rs:L261-L265 |
| `curve25519_dalek.scalar.Scalar.invert` | ✓ | 18 | curve25519-dalek/src/scalar.rs:L747-L749 |
| `curve25519_dalek.scalar.Scalar.non_adjacent_form` |  | 12 | curve25519-dalek/src/scalar.rs:L931-L983 |
| `curve25519_dalek.scalar.Scalar.to_bytes` | ✓ | 29 | curve25519-dalek/src/scalar.rs:L691-L693 |
| `curve25519_dalek.scalar.Scalar.to_radix_2w_size_hint` |  | 2 | curve25519-dalek/src/scalar.rs:L1036-L1056 |

## 内部 helper（需核对 Rust 源：是否只在测试中使用）（3 条）

| Lean 名 | spec | grep | 位置 |
|---|---|---|---|
| `curve25519_dalek.backend.serial.curve_models.ProjectivePoint.as_extended` | ✓ | 33 | curve25519-dalek/src/backend/serial/curve_models/mod.rs:L339-L346 |
| `curve25519_dalek.backend.serial.u64.field.FieldElement51.as_bytes` | ✓ | 20 | curve25519-dalek/src/backend/serial/u64/field.rs:L369-L371 |
| `curve25519_dalek.backend.serial.u64.scalar.Scalar52.square` | ✓ | 38 | curve25519-dalek/src/backend/serial/u64/scalar.rs:L319-L322 |

## trait 实现方法（65 条）

| Lean 名 | spec | 疑似外部调用者 | 位置 |
|---|---|---|---|
...
| `curve25519_dalek.backend.serial.curve_models.AffineNielsPoint.Insts.CoreCmpPartialEqAffineNielsPoint.eq` | ✓ | called by core's default PartialEq::ne, an axiom in FunsExternal.lean | curve25519-dalek/src/backend/serial/curve_models/mod.rs:L182-L182 |
...
| `curve25519_dalek.backend.serial.curve_models.AffineNielsPoint.Insts.SubtleConditionallySelectable.conditional_select` | ✓ | called by subtle's default conditional_assign / conditional_swap, modelled in FunsExternal.lean | curve25519-dalek/src/backend/serial/curve_models/mod.rs:L315-L321 |
...
| `curve25519_dalek.edwards.EdwardsPoint.Insts.CoreCmpPartialEqEdwardsPoint.eq` | ✓ | called by core's default PartialEq::ne, an axiom in FunsExternal.lean | curve25519-dalek/src/edwards.rs:L507-L509 |
...
| `curve25519_dalek.edwards.affine.AffinePoint.Insts.CoreCmpPartialEqAffinePoint.eq` | ✓ | called by core's default PartialEq::ne, an axiom in FunsExternal.lean | curve25519-dalek/src/edwards/affine.rs:L48-L50 |
...
| `curve25519_dalek.edwards.affine.AffinePoint.Insts.SubtleConditionallySelectable.conditional_select` | ✓ | called by subtle's default conditional_assign / conditional_swap, modelled in FunsExternal.lean | curve25519-dalek/src/edwards/affine.rs:L24-L29 |
| `curve25519_dalek.montgomery.MontgomeryPoint.Insts.CoreCloneClone.clone` |  |  | curve25519-dalek/src/montgomery.rs:L73-L73 |
| `curve25519_dalek.montgomery.MontgomeryPoint.Insts.CoreCmpPartialEqMontgomeryPoint.eq` | ✓ | called by core's default PartialEq::ne, an axiom in FunsExternal.lean | curve25519-dalek/src/montgomery.rs:L94-L96 |
...
| `curve25519_dalek.montgomery.MontgomeryPoint.Insts.SubtleConditionallySelectable.conditional_select` | ✓ | called by subtle's default conditional_assign / conditional_swap, modelled in FunsExternal.lean | curve25519-dalek/src/montgomery.rs:L88-L90 |
...
| `curve25519_dalek.montgomery.ProjectivePoint.Insts.SubtleConditionallySelectable.conditional_select` | ✓ | called by subtle's default conditional_assign / conditional_swap, modelled in FunsExternal.lean | curve25519-dalek/src/montgomery.rs:L312-L321 |
...
| `curve25519_dalek.ristretto.RistrettoPoint.Insts.CoreCmpPartialEqRistrettoPoint.eq` | ✓ | called by core's default PartialEq::ne, an axiom in FunsExternal.lean | curve25519-dalek/src/ristretto.rs:L859-L861 |
...
| `curve25519_dalek.ristretto.RistrettoPoint.Insts.SubtleConditionallySelectable.conditional_select` | ✓ | called by subtle's default conditional_assign / conditional_swap, modelled in FunsExternal.lean | curve25519-dalek/src/ristretto.rs:L1192-L1198 |
| `curve25519_dalek.scalar.Scalar.Insts.CoreCloneClone.clone` |  |  | curve25519-dalek/src/scalar.rs:L194-L194 |
| `curve25519_dalek.scalar.Scalar.Insts.CoreCmpPartialEqScalar.eq` | ✓ | called by core's default PartialEq::ne, an axiom in FunsExternal.lean | curve25519-dalek/src/scalar.rs:L295-L297 |
...
| `curve25519_dalek.scalar.Scalar.Insts.SubtleConditionallySelectable.conditional_select` |  | called by subtle's default conditional_assign / conditional_swap, modelled in FunsExternal.lean | curve25519-dalek/src/scalar.rs:L390-L397 |
